            ...
            <div class="card crud-datatable-card">
              <div class="card-body">
                <div class="crud-datatable-intro">
                  <div>
                    <h5 class="card-title mb-1"><?= h(t('__PAGE_KEY_PREFIX___table_title', 'Management Listing')) ?></h5>
                    <p class="text-muted mb-0"><?= h(t('__PAGE_KEY_PREFIX___table_subtitle', 'Use this generated page as the starting point for admin modules that need listing, modal CRUD, and polished interaction flow.')) ?></p>
                  </div>
                      ...
                      <?php foreach ($rows as $index => $row): ?>
                        ...
                        <tr data-row-index="<?= h((string)$index) ?>">
                          ...
                          <td class="col-actions">
                            <button type="button" class="btn btn-outline-warning btn-sm js-view-row" data-row='<?= h((string)$rowJson) ?>' title="<?= h(t('__PAGE_KEY_PREFIX___btn_view', 'View')) ?>">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="sampleViewModalTitle">
          <i class="ri-eye-line"></i> <?= h(t('__PAGE_KEY_PREFIX___modal_view_title', 'View Record')) ?>
        </h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?= h(t('__PAGE_KEY_PREFIX___btn_close', 'Close')) ?>"></button>
      </div>
      <div class="modal-body">
        <div class="sample-view-grid">
          <div>
            <div class="sample-view-label"><?= h(t('__PAGE_KEY_PREFIX___field_name', 'Name')) ?></div>
            <div class="sample-view-value" id="sampleViewName">-</div>
          </div>
          <div>
            <div class="sample-view-label"><?= h(t('__PAGE_KEY_PREFIX___field_department', 'Department')) ?></div>
            <div class="sample-view-value" id="sampleViewDepartment">-</div>
          </div>
          <div>
            <div class="sample-view-label"><?= h(t('__PAGE_KEY_PREFIX___field_group', 'Group')) ?></div>
            <div class="sample-view-value" id="sampleViewGroup">-</div>
          </div>
          <div>
            <div class="sample-view-label"><?= h(t('__PAGE_KEY_PREFIX___field_access', 'Access')) ?></div>
            <div class="sample-view-value" id="sampleViewAccess">-</div>
          </div>
          <div class="sample-view-span">
            <div class="sample-view-label"><?= h(t('__PAGE_KEY_PREFIX___field_description', 'Description')) ?></div>
            <div class="sample-view-value" id="sampleViewDescription">-</div>
          </div>
          <div>
            <div class="sample-view-label"><?= h(t('__PAGE_KEY_PREFIX___field_updated_at', 'Last Updated')) ?></div>
            <div class="sample-view-value" id="sampleViewUpdatedAt">-</div>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?= h(t('__PAGE_KEY_PREFIX___btn_close', 'Close')) ?></button>
      </div>
    </div>
  </div>
</div>
