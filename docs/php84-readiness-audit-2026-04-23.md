...
> Historical note: Docker runtime references below describe the environment assessed on the audit date. The current SAP repository uses the native WSL, Nginx, and PHP-FPM runtime documented in `README.md`.
